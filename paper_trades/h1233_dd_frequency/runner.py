"""
H-1233 Drawdown Frequency XS Paper Trade Runner

Fewer >2% drawdown episodes in 60d → outperforms. Stability premium.
Backtest: IS Sharpe 1.155, WF 3/3 PERFECT, SH 1.59/0.58, p=0.119, H-012 corr 0.079.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Drawdown Frequency: number of >2% drawdown episodes in 60d."""
...
def run():
    print("=== H-1233 Drawdown Frequency XS Paper Trade Runner ===")
