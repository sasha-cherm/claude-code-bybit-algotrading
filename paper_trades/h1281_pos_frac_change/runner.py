"""
H-1281 Positive Return Fraction Change XS Paper Trade Runner

10d win rate minus 20d win rate. Improving success rate → outperforms.
Backtest: IS Sharpe 1.436, WF 3/4, SH 1.08/2.11, p=0.047, H-012 corr 0.016.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    return pos_frac_10 - pos_frac_20
...
def run():
    print("=== H-1281 Positive Return Fraction Change XS Paper Trade Runner ===")
