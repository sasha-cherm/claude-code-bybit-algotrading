"""
H-1284 Distance from 60d High XS Paper Trade Runner

(close - high_60d) / high_60d. Assets closer to recent peak outperform.
Backtest: IS Sharpe 1.197, WF 4/4 PERFECT, SH 1.64/0.69, p=0.098, H-012 corr 0.001.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    high_60 = closes_df.rolling(60).max()
    return (closes_df - high_60) / (high_60 + 1e-10)
...
def run():
    print("=== H-1284 Distance from 60d High XS Paper Trade Runner ===")
