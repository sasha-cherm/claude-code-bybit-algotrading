"""
H-1162 Price Acceleration XS Paper Trade Runner

Low_long: long decelerating (contrarian), short accelerating assets.
Backtest: IS Sharpe 1.503, WF 3/4, SH 2.14/0.71, p=0.038, H-012 corr -0.049.
Params: R=5, N=3, dir=low_long.
"""
...
def compute_signal(closes_df, volumes_df):
    """Acceleration: 5d ROC minus lagged 5d ROC (second derivative)."""
    roc5 = closes_df.pct_change(5)
    roc5_lag = roc5.shift(5)
    return roc5 - roc5_lag
...
def run():
    print("=== H-1162 Price Acceleration XS Paper Trade Runner ===")
