"""
H-946 Kappa Ratio XS Paper Trade Runner

Mean return / sqrt(lower partial moment). Penalizes downside only.
Backtest: IS Sharpe 1.251, WF 4/5, SH p=0.082, H-012 corr -0.014.
...
def run():
    print("=== H-946 Kappa Ratio XS Paper Trade Runner ===")
