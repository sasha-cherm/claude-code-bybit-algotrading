"""
H-1356 Short-Long Momentum Gap XS Paper Trade Runner

Risk-adjusted 5d momentum minus risk-adjusted 20d momentum. Low gap = recent underperformance vs longer trend (contrarian).
Backtest: IS Sharpe 1.601, WF 3/4, SH 1.97/1.16, p=0.027, H-012 corr -0.012. SESSION BEST.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1356: (5d ret / 5d std) - (20d ret / 20d std). Low = recent underperformance vs longer trend."""
    returns = closes_df.pct_change()
    ret5 = closes_df.pct_change(5)
    ret20 = closes_df.pct_change(20)
...
def run():
    print("=== H-1356 Short-Long Momentum Gap XS Paper Trade Runner ===")
