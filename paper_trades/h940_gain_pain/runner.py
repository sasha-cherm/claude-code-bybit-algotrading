"""
H-940 Gain-to-Pain Ratio XS Paper Trade Runner

Sum of returns / |sum of negative returns|. Higher = more gains per unit of pain.
Backtest: IS Sharpe 1.356, WF 4/5, SH p=0.060, H-012 corr 0.014.
...
def run():
    print("=== H-940 Gain-to-Pain Ratio XS Paper Trade Runner ===")
