"""
H-1350 Right Tail Growth XS Paper Trade Runner

95th percentile of recent 20d returns minus 95th percentile of prior 20d. High = right tail expanding (bigger positive moves).
Backtest: IS Sharpe 1.130, WF 3/4, SH 1.26/0.99, p=0.118, H-012 corr -0.049.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1350: p95(recent 20d) - p95(prior 20d). High = right tail expanding."""
...
def run():
    print("=== H-1350 Right Tail Growth XS Paper Trade Runner ===")
