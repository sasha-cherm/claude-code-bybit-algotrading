"""
H-1335 Consecutive Candle Momentum XS Paper Trade Runner

Max consecutive green candles in 20d. Strong bullish persistence predicts continuation.
Backtest: IS Sharpe 1.600, WF 4/4 PERFECT, SH 2.11/0.97, p=0.027, H-012 corr -0.061.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1335 Consecutive Candle Momentum — max consec green in 20d."""
        ...
        for i in range(20, len(s)):
            ...
            for g in green:
                if g:
                    ...
                    current = 0
            result.at[result.index[i], col] = max_run
    return result
...
def run():
    print("=== H-1335 Consecutive Candle Momentum XS Paper Trade Runner ===")
