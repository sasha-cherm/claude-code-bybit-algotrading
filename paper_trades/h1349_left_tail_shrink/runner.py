"""
H-1349 Left Tail Shrinkage XS Paper Trade Runner

5th percentile of recent 20d returns minus 5th percentile of prior 20d. High = left tail shrinking (less extreme losses).
Backtest: IS Sharpe 1.390, WF 3/4, SH 1.14/1.79, p=0.054, H-012 corr 0.009.
...
def run():
    print("=== H-1349 Left Tail Shrinkage XS Paper Trade Runner ===")
