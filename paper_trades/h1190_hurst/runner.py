"""
H-1190 Hurst Exponent XS Paper Trade Runner

Long high Hurst (trending) assets, short low Hurst (mean-reverting).
Backtest: IS Sharpe 1.725, WF 3/4, SH 1.89/1.67, p=0.017, H-012 corr -0.075.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Hurst Exponent (R/S method, 40d window)."""
...
def run():
    print("=== H-1190 Hurst Exponent XS Paper Trade Runner ===")
