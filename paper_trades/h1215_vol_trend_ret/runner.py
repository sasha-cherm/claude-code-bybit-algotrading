"""
H-1215 Volume Trend Return XS Paper Trade Runner

Correlation between cumulative volume and cumulative returns over 20d. Price-volume agreement.
Backtest: IS Sharpe 1.656, WF 3/4, SH 1.60/1.77, p=0.022, H-012 corr -0.032.
Params: R=3, N=4, dir=high_long.
"""
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    """Volume Trend Return: corr(cumulative vol, cumulative ret) over 20d."""
...
def run():
    print("=== H-1215 Volume Trend Return XS Paper Trade Runner ===")
