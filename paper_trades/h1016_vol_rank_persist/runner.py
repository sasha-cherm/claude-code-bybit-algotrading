"""
H-1016 Volume Rank Persistence XS Paper Trade Runner

Mean volume rank over 30-day lookback.
Consistently high-volume = sustained institutional attention.
Backtest: IS Sharpe 1.417, WF 4/4, SH p=0.051, H-012 corr 0.045.
...
def run():
    print("=== H-1016 Volume Rank Persistence XS Paper Trade Runner ===")
