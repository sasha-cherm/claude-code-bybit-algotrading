"""
H-1100 Amihud Illiquidity Ratio XS Paper Trade Runner

Long most liquid assets (lowest Amihud), short least liquid.
Amihud = rolling 20d mean of |return| / dollar_volume.
Backtest: IS Sharpe 1.609, WF 3/3, SH 1.41/1.83, p=0.030, H-012 corr 0.471.
...
def compute_signal(closes_df, volumes_df):
    """Amihud illiquidity: rolling 20d mean of |return| / dollar_volume."""
...
def compute_rankings(signal_df):
    ...
    ranked = sig_row.sort_values(ascending=True)  # low_long: long lowest illiquidity
    weights = {}
...
def run():
    print("=== H-1100 Amihud Illiquidity XS Paper Trade Runner ===")
