"""
H-1265 CVaR 5% XS Paper Trade Runner

Mean of worst 5% of returns over 30d. Less extreme downside → outperforms.
Backtest: IS Sharpe 2.188, WF 3/4, SH 2.36/2.01, p=0.003, H-012 corr -0.048. BATCH BEST.
...
def run():
    print("=== H-1265 CVaR 5% XS Paper Trade Runner ===")
