"""
H-1234 Mean Recovery Time XS Paper Trade Runner

High mean recovery time → outperforms (contrarian: slow recoverers are oversold).
Backtest: IS Sharpe 1.253, WF 2/3, SH 1.62/0.74, p=0.091, H-012 corr 0.085.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Mean Recovery Time: avg days to recover from >1% drawdowns in 60d."""
...
def run():
    print("=== H-1234 Mean Recovery Time XS Paper Trade Runner ===")
