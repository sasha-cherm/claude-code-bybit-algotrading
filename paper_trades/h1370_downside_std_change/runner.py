"""
H-1370 Downside Semi-Std Change XS Paper Trade Runner

Std of NEGATIVE returns recent 20d minus prior 20d. Low = downside compressing.
Long those whose downside vol shrunk (flight to quality); short expanding downside vol.
Backtest: IS Sharpe 1.346, WF 3/4, SH 1.37/1.35, p=0.063, H-012 corr 0.039.
...
def compute_signal(closes_df):
    """Std of negative returns recent 20d - prior 20d."""
...
def run():
    print("=== H-1370 Downside Semi-Std Change XS Paper Trade Runner ===")
