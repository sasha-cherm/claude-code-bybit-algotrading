"""
H-1155 ROC Divergence XS Paper Trade Runner

Short-term (5d) ROC minus long-term (20d) ROC. Low_long: long deceleration.
Backtest: IS Sharpe 1.220, WF 2/4, SH 1.44/0.96, p=0.091, H-012 corr -0.006.
...
def compute_signal(closes_df, volumes_df):
    """ROC Divergence: 5d ROC - 20d ROC."""
    roc5 = closes_df.pct_change(5)
    roc20 = closes_df.pct_change(20)
    return roc5 - roc20
...
def run():
    print("=== H-1155 ROC Divergence XS Paper Trade Runner ===")
