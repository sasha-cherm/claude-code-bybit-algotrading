"""
H-1371 Upside Semi-Std Change XS Paper Trade Runner

Std of POSITIVE returns in recent 20d minus std of positive returns in prior 20d.
High = upside vol expanding. Long these; short shrinking.
Backtest: IS Sharpe 1.395, WF 4/4 PERFECT, SH 1.41/1.42, p=0.054, H-012 corr -0.023.
...
def semi_std(series, window, side="up"):
...
def compute_signal(closes_df):
    """Std of positive returns recent 20d - prior 20d."""
...
def run():
    print("=== H-1371 Upside Semi-Std Change XS Paper Trade Runner ===")
