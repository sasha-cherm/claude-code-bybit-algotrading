"""
H-1243 Tail Asymmetry Ratio XS Paper Trade Runner

High tail asymmetry (positive tail larger than negative) → outperforms.
Backtest: IS Sharpe 1.184, WF 3/4, SH 1.47/0.83, p=0.101, H-012 corr 0.013.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Tail Asymmetry Ratio: 95th percentile return / abs(5th percentile return) over 20d."""
...
def run():
    print("=== H-1243 Tail Asymmetry Ratio XS Paper Trade Runner ===")
