"""
H-1355 Distribution Width Change XS Paper Trade Runner

IQR of recent 20d returns minus IQR of prior 20d returns. High = distribution widening (expanding vol regime).
Backtest: IS Sharpe 1.421, WF 2/4, SH 1.30/1.67, p=0.049, H-012 corr 0.025.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1355: IQR(recent 20d) - IQR(prior 20d). High = widening distribution."""
...
def run():
    print("=== H-1355 Distribution Width Change XS Paper Trade Runner ===")
