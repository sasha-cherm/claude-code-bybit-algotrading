"""
H-960 Longest Win Streak XS Paper Trade Runner

Max consecutive positive return days in lookback window.
Backtest: IS Sharpe 1.453, WF 4/5, SH p=0.043, H-012 corr -0.020.
...
def run():
    print("=== H-960 Longest Win Streak XS Paper Trade Runner ===")
