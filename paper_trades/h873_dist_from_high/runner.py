"""
H-873 Distance from 20-Day High XS Paper Trade Runner

Close / rolling_max - 1. Long assets near high, short far from high.

Backtest: IS Sharpe 1.391, WF 4/5, SH p=0.053, H-012 corr 0.023.
Best params: W=20, R=7, N=4.
"""
...
def compute_rankings(daily_dict):
    ...
    signal = closes / rolling_high.replace(0, np.nan) - 1
...
def run():
    print("=== H-873 Distance from 20-Day High XS Paper Trade Runner ===")
