"""
H-1218 Positive Volume Momentum XS Paper Trade Runner

Vol on best 5 return days / vol on worst 5 return days over 20d window. Buying dominance.
Backtest: IS Sharpe 1.585, WF 3/4, SH 2.17/0.89, p=0.028, H-012 corr -0.017.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    """Positive Vol Momentum: vol on top 5 return days / vol on bottom 5 over 20d."""
...
def run():
    print("=== H-1218 Positive Volume Momentum XS Paper Trade Runner ===")
