"""
H-961 Tail Improvement XS Paper Trade Runner

Change in 5th percentile daily return. Improving (less negative) = better downside protection.
Backtest: IS Sharpe 1.244, WF 3/4, SH p=0.099, H-012 corr 0.018.
Best params: P=60, D=20, R=7, N=3.
"""
...
def compute_rankings(daily_dict):
    ...
    p5 = ret.rolling(60).quantile(0.05)
    signal = p5.diff(20).iloc[-1]  # improving tail = positive change
...
def run():
    print("=== H-961 Tail Improvement XS Paper Trade Runner ===")
