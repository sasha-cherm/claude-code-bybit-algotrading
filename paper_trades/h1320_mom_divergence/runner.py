"""
H-1320 Momentum Divergence XS Paper Trade Runner

14d return minus equal-weight market 14d return. Short-term relative momentum.
Backtest: IS Sharpe 1.416, WF 3/4, SH 1.38/1.53, p=0.050, H-012 corr 0.036.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1320 Momentum Divergence — 14d return minus market avg 14d return."""
    ret14 = closes_df.pct_change(14)
    mkt_ret14 = ret14.mean(axis=1)
    return ret14.sub(mkt_ret14, axis=0)
...
def run():
    print("=== H-1320 Momentum Divergence XS Paper Trade Runner ===")
