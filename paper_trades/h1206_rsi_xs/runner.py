"""
H-1206 RSI(14) XS Ranking XS Paper Trade Runner

Rank assets by RSI(14) cross-sectionally. Long high RSI (momentum), short low RSI.
Backtest: IS Sharpe 1.437, WF 3/4, SH 0.71/2.49, p=0.047, H-012 corr 0.059.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    """RSI(14) ranked cross-sectionally."""
...
def run():
    print("=== H-1206 RSI(14) XS Ranking XS Paper Trade Runner ===")
