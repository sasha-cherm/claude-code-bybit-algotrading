"""
H-1308 Volume Trend Slope XS Paper Trade Runner

Slope of linear regression on log(volume) over 20d. Rising volume interest = outperforms.
Backtest: IS Sharpe 1.514, WF 3/4, SH 1.67/1.34, p=0.036, H-012 corr 0.012.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """H-1308 Volume Trend Slope — linreg slope on log(volume), 20d."""
    log_vol = np.log(volumes_df + 1)
...
def run():
    print("=== H-1308 Volume Trend Slope XS Paper Trade Runner ===")
