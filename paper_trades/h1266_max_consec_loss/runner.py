"""
H-1266 Max Consecutive Loss XS Paper Trade Runner

Longest losing streak in 30d. Shorter streaks = more stable → outperforms.
Backtest: IS Sharpe 1.338, IS 100%, WF 3/4, SH 1.48/1.18, p=0.064, H-012 corr -0.013.
...
def run():
    print("=== H-1266 Max Consecutive Loss XS Paper Trade Runner ===")
