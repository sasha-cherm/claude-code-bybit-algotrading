"""
H-1237 Up-Down Volume Asymmetry XS Paper Trade Runner

High up-vol/down-vol ratio → outperforms (buying pressure dominance).
Backtest: IS Sharpe 0.817, WF 4/4 PERFECT, SH 0.60/1.09, p=0.258, H-012 corr 0.013.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Up-Down Volume Asymmetry: mean vol on up days / mean vol on down days over 20d."""
...
def run():
    print("=== H-1237 Up-Down Volume Asymmetry XS Paper Trade Runner ===")
