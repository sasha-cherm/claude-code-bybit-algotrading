"""
H-867 Max Gain Dependency XS Paper Trade Runner

Short assets where most return came from single day (fragile momentum).

Backtest: IS Sharpe 1.766, WF 3/4, SH p=0.015, H-012 corr 0.046.
Best params: W=40, R=7, N=4.
"""
...
def run():
    print("=== H-867 Max Gain Dependency XS Paper Trade Runner ===")
