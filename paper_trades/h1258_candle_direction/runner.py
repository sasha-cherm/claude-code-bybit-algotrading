"""
H-1258 Candle Direction Consistency XS Paper Trade Runner

Fraction of bullish candles (close>open) in 20d. Consistent bullish action.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Candle Direction Consistency XS."""
    bullish = (closes_df > opens_df).astype(float)
    return bullish.rolling(20).mean()
...
def run():
    print("=== H-1258 Candle Direction Consistency XS Paper Trade Runner ===")
