"""
H-837 Paper Trade Runner: Volume Turnover Rate XS

Volume turnover = dollar_volume / rolling_avg_dollar_volume.
High turnover = active trading interest = momentum confirmation.

Backtest: IS Sharpe 1.958, WF 5/5 PERFECT, SH p=0.006.
H-012 corr 0.058. 100% param robust.
Best params: W=10, R=3, N=3.
"""
...
def run():
    print("=== H-837 Volume Turnover Paper Trade Runner ===")
