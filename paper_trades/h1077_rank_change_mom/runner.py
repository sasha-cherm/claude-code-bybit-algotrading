"""
H-1077 Rank Change Momentum XS Paper Trade Runner

Assets improving in XS return rank → long. Deteriorating → short.
Backtest: IS Sharpe 1.390, WF 3/4, SH p=0.053, H-012 corr -0.031.
...
def compute_signal(closes_df):
    """Rank change momentum: change in XS return rank over 5d vs 10d ago."""
...
def run():
    print("=== H-1077 Rank Change Momentum XS Paper Trade Runner ===")
