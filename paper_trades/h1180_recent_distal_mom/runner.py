"""
H-1180 Recent vs Distal Momentum XS Paper Trade Runner

Long assets with LOWER recent vs distal momentum (contrarian — momentum deceleration signal).
Backtest: IS Sharpe 2.047, WF 3/4, SH 1.97/2.25, p=0.005, H-012 corr 0.034.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Recent vs Distal Momentum: 5d return now minus 5d return from 55d ago."""
    ret5 = closes_df.pct_change(5)
    ret5_distal = ret5.shift(55)
    return ret5 - ret5_distal
...
def run():
    print("=== H-1180 Recent vs Distal Momentum XS Paper Trade Runner ===")
