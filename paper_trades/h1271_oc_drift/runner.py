"""
H-1271 Open-to-Close Drift XS Paper Trade Runner

(close-open)/open avg 20d. Intraday directional drift.
Backtest: IS Sharpe 1.135, WF 3/4, SH 0.96/1.40, p=0.116, H-012 corr 0.039.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    oc_drift = (closes_df - opens_df) / (opens_df + 1e-10)
    return oc_drift.rolling(20).mean()
...
def run():
    print("=== H-1271 Open-to-Close Drift XS Paper Trade Runner ===")
