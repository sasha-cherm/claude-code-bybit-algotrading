"""
H-1276 Variance Trend XS Paper Trade Runner

10d return variance / 30d return variance. Increasing vol → outperforms.
Backtest: IS Sharpe 1.225, WF 3/4, SH 0.73/1.86, p=0.090, H-012 corr 0.026.
...
def run():
    print("=== H-1276 Variance Trend XS Paper Trade Runner ===")
