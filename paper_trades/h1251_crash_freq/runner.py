"""
H-1251 Crash Frequency XS Paper Trade Runner

Number of >3% decline days in 60d. Fewer crashes = more stable → outperforms.
Backtest: IS Sharpe 1.046, WF 4/4 PERFECT, SH 1.02/1.08, p=0.148, H-012 corr -0.056.
...
def run():
    print("=== H-1251 Crash Frequency XS Paper Trade Runner ===")
