"""
H-1041 Trend Persistence Ratio XS Paper Trade Runner

Fraction of days with same-sign return as overall 30d trend. High = persistent quality trend.
Backtest: IS Sharpe 1.304, WF 3/4, SH p=0.072, H-012 corr 0.006.
...
def run():
    print("=== H-1041 Trend Persistence Ratio XS Paper Trade Runner ===")
