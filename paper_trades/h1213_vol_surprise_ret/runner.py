"""
H-1213 Volume Surprise Return XS Paper Trade Runner

Average return on high-volume days (vol > 1.5σ) over 20d. Informed trading signal.
Backtest: IS Sharpe 1.456, WF 3/4, SH 2.14/0.56, p=0.044, H-012 corr 0.003.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    ...
    """Volume Surprise Return: avg return on high-volume days over 20d."""
...
def run():
    print("=== H-1213 Volume Surprise Return XS Paper Trade Runner ===")
