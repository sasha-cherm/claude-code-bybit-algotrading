"""
H-963 Return Concentration XS Paper Trade Runner

max(|daily_return|) / sum(|daily_return|). Low concentration = distributed (sustainable) gains.
Backtest: IS Sharpe 1.506, WF 3/5, SH p=0.037, H-012 corr 0.004.
Best params: P=20, R=7, N=3.
"""
...
def compute_rankings(daily_dict):
    ...
    for col in closes.columns:
        ...
        signal[col] = -(max_abs / total_abs)  # negative: low concentration = long
...
def run():
    print("=== H-963 Return Concentration XS Paper Trade Runner ===")
