"""
H-1194 Trend Linearity XS Paper Trade Runner

Long high trend linearity (clean trending) assets, short noisy ones.
Backtest: IS Sharpe 1.316, WF 3/4, SH 1.28/1.40, p=0.069, H-012 corr -0.036.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Trend Linearity: signed R² of linear regression on log-closes over 20d."""
    log_c = np.log(closes_df.clip(lower=1e-10))
...
def run():
    print("=== H-1194 Trend Linearity XS Paper Trade Runner ===")
