"""
H-1221 Approximate Entropy XS Paper Trade Runner

Low approximate entropy (more regular/predictable returns) → outperforms.
Backtest: IS Sharpe 1.288, WF 3/4, SH 1.93/0.50, p=0.075, H-012 corr 0.075.
...
def compute_signal(closes_df, volumes_df, opens_df=None, highs_df=None, lows_df=None):
    """Approximate Entropy: regularity of return series over 20d."""
...
def run():
    print("=== H-1221 Approximate Entropy XS Paper Trade Runner ===")
