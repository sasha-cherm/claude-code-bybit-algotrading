...
## H-884: Hurst Exponent XS
- Status: REJECTED
- Idea: Hurst exponent (trending vs mean-reverting) as XS factor. Long trending assets, short mean-reverting.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P30 IS 67% pos Sharpe 0.810. P60 IS 100% pos but Sharpe 0.742. Below threshold.
- Sessions: [2026-04-13 session 191]

## H-885: AR(1) Coefficient XS
- Status: REJECTED
- Idea: Lag-1 autocorrelation of returns ranked cross-sectionally.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P20 IS 0% positive Sharpe -0.268. P30 33% pos. P45 67% pos. AR(1) doesn't work as XS signal.
- Sessions: [2026-04-13 session 191]

## H-886: Volatility of Volatility XS
- Status: REJECTED
- Idea: Vol-of-vol (coefficient of variation of rolling vol) as uncertainty signal.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: All params 0% positive, Sharpe -0.56 to -1.23. Low vol-of-vol does NOT predict returns.
- Sessions: [2026-04-13 session 191]

## H-887: Maximum Adverse Excursion XS
- Status: REJECTED
- Idea: Worst intra-period drawdown as resilience indicator. Long resilient, short fragile.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: All 0% positive, Sharpe -0.55 to -0.76. Resilient assets underperform (contrarian to MAE is reversal = fails in crypto).
- Sessions: [2026-04-13 session 191]

## H-888: Parkinson Volatility Ratio XS
- Status: REJECTED
- Idea: Range-based vs close-close vol ratio. Low ratio = clean trends.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: All 0% positive, Sharpe -0.07 to -0.47. Parkinson ratio has no XS predictive power.
- Sessions: [2026-04-13 session 191]

## H-889: Return Autocorrelation Profile XS
- Status: REJECTED
- Idea: Sum of lag-1 to lag-5 autocorrelation. Positive sum = momentum persistence.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P20 IS 67% pos Sharpe 0.820. P30 100% pos but 0.545. Below threshold.
- Sessions: [2026-04-13 session 191]

## H-890: Conditional Tail Expectation (CVaR) XS
- Status: REJECTED
- Idea: Expected shortfall at 5% level. Long low tail risk, short high.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: All 0% positive, Sharpe -0.54 to -1.22. Tail risk is NOT priced in crypto XS (no low-CVaR premium).
- Sessions: [2026-04-13 session 191]

## H-891: Up/Down Day Ratio XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Proportion of positive return days over lookback. High = consistent upward sentiment.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.233 (P20, R5_N3), 100% params positive, WF 4/5, SH p=0.087, H-012 corr 0.015.
- Notes: Different from raw momentum — captures consistency of direction. Near-zero correlation with H-012.
- Sessions: [2026-04-13 session 191]

## H-892: Volume Acceleration XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Second derivative of volume — change in short/long volume ratio. Acceleration of buying pressure.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.455 (S7/L30, R7_N3), 100% params positive, WF 3/4, SH p=0.045, H-012 corr -0.026.
- Notes: Volume acceleration captures momentum of institutional attention. Strong SH pass.
- Sessions: [2026-04-13 session 191]

## H-893: Volume Volatility XS
- Status: REJECTED
- Idea: Coefficient of variation of volume. Low vol-vol = stable institutional flow.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P14 33% pos Sharpe 0.501. P20/P30 0% positive. Volume stability doesn't predict returns.
- Sessions: [2026-04-13 session 191]

## H-894: Volume-Price Correlation XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Rolling correlation between returns and volume. Positive = volume confirms price moves.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.314 (P14, R5_N3), 100% params positive, WF 4/5, SH p=0.067, H-012 corr 0.048.
- Notes: Volume confirmation is a genuine signal — assets where volume supports price direction outperform.
- Sessions: [2026-04-13 session 191]

## H-895: Dollar Volume Rank Change XS
- Status: REJECTED
- Idea: Drift in volume ranking (short-term rank vs long-term rank).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: 5/20 version WF 3/5 but SH p=0.166 (FAIL). 7/30 version WF 2/4 (FAIL). Ranking drift doesn't persist.
- Sessions: [2026-04-13 session 191]

## H-896: Relative Volume XS
- Status: REJECTED
- Idea: Current vs historical average volume. High RVOL = unusual activity.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.798 but WF 0/4 (TOTAL FAIL). Classic IS overfitting — RVOL has no OOS predictive power.
- Sessions: [2026-04-13 session 191]

## H-897: Volume Concentration XS
- Status: REJECTED
- Idea: Herfindahl index of volume share variability. Concentrated vs dispersed volume.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P14 50% pos. P20 100% pos but Sharpe 0.646. P30 83% pos Sharpe 0.479. Below threshold.
- Sessions: [2026-04-13 session 191]

## H-898: Cumulative Volume Divergence XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Cumulative sum of (vol - SMA(vol)) / SMA(vol). Sustained above-average volume = accumulation.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.713 (S3/L20, R3_N3), 100% params positive, WF 4/5, SH p=0.018, H-012 corr -0.008 (near zero!).
- Notes: Strong signal — sustained volume divergence captures accumulation/distribution. Best config (3/20) had WF 4/5 vs the highest-IS config (7/30) which had WF 2/4.
- Sessions: [2026-04-13 session 191]

## H-899: Volume Trend Persistence XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Proportion of days with above-average volume. Sustained high volume = institutional interest.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.560 (P20, R7_N4), 100% params positive, WF **5/5 PERFECT**, SH p=0.030, H-012 corr -0.048.
- Notes: **SESSION BEST**. Perfect walk-forward, strong SH, negative H-012 correlation. Volume persistence is a robust, independent signal.
- Sessions: [2026-04-13 session 191]

## H-900: Timeframe Consistency XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Sign agreement of returns across 3d/7d/14d/30d timeframes. +4 = all up, -4 = all down.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.460 (R7_N4), 83% params positive, WF 3/4, SH p=0.044, H-012 corr -0.004 (near zero!).
- Notes: Multi-timeframe confirmation captures strong cross-horizon trends. Near-zero correlation with pure momentum.
- Sessions: [2026-04-13 session 191]

## H-901: Momentum Acceleration XS
- Status: REJECTED
- Idea: Change in momentum strength (short-term mom minus normalized long-term mom).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: 7/30 IS 17% pos Sharpe 0.230. 14/60 100% pos but Sharpe 0.443. 10/45 33% pos. Momentum acceleration doesn't work.
- Sessions: [2026-04-13 session 191]

## H-902: Momentum Quality XS
- Status: LIVE (paper trade since 2026-04-13)
- Idea: Mean(daily ret) / std(daily ret) = Sharpe-like measure. High quality = consistent positive returns.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.598 (P14, R7_N3), 100% params positive, WF 3/5, SH p=0.026, H-012 corr -0.017.
- Notes: Risk-adjusted momentum is different from raw momentum. Filters out noisy high-return/high-vol assets.
- Sessions: [2026-04-13 session 191]

## H-903: Return Dispersion Ratio XS
- Status: REJECTED
- Idea: Std of daily returns / abs(total period return). Low dispersion = smooth directional move.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P30 IS Sharpe 2.108 but WF 1/4 (FAIL). Classic IS overfitting — smooth trend selection doesn't persist OOS.
- Sessions: [2026-04-13 session 191]

## H-904: Direction Count XS
- Status: CONFIRMED (not deployed — similar to H-891)
- Idea: Net count of up days minus down days over lookback.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.231 (P14, R7_N3), 100% params positive, WF 4/5, SH p=0.086, H-012 corr -0.036.
- Notes: Very similar to H-891 Up/Down Ratio. Not deployed to avoid redundancy. WF results nearly identical.
- Sessions: [2026-04-13 session 191]

## H-905: Weighted Return Consistency XS
- Status: REJECTED
- Idea: Time-weighted sum of returns (recent days weighted more).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P14 IS Sharpe 0.934, WF 3/5 but SH p=0.193 (FAIL). P20/P30 below Sharpe threshold. Time-weighting adds noise.
- Sessions: [2026-04-13 session 191]

## H-906: Momentum Gap XS
- Status: REJECTED
- Idea: Distance from cross-sectional mean momentum. Extreme outperformers.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: P14 SH p=0.234 (FAIL). P60 SH p=0.133 (FAIL). Extreme momentum distance doesn't persist.
- Sessions: [2026-04-13 session 191]

## H-907: Normalized Momentum XS
- Status: REJECTED
- Idea: Momentum / volatility (risk-adjusted XS momentum). Different from H-902 in dividing total return by vol.
- Instrument: futures (14 perps)
- Timeframe: 1D
...
## H-1028: Turn-of-Month Effect XS
- Status: CONFIRMED (deployed session 197)
- Idea: Rank assets by their turn-of-month return premium (last 3 + first 3 days vs mid-month). Long high-TOM-premium assets.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 7d)
- Result: IS Sharpe **1.979**, WF 3/4, SH p=**0.008**, H-012 corr **-0.031**. Split-half: 2.198/1.735 (stable).
- Notes: Calendar seasonality per asset — TOM effect exists and varies cross-sectionally. Strong IS and OOS. Near-zero corr with momentum.
- Sessions: [2026-04-14 session 197]

## H-1029: Monthly Return Persistence XS
- Status: REJECTED
- Idea: Last 30-day XS return rank as predictor.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.623. Below 0.8 threshold.
- Notes: Monthly momentum too slow for crypto XS — 60d momentum (H-012) works, 30d doesn't.
- Sessions: [2026-04-14 session 197]

## H-1030: Return Horizon Ratio XS
- Status: CONFIRMED (not deployed — unstable split-half)
- Idea: 7d/30d return ratio — momentum acceleration signal.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe **1.724**, WF 3/4, SH p=**0.018**, H-012 corr 0.012. Split-half: 2.995/**-0.113** (COLLAPSE in 2nd half).
- Notes: Strong IS but second half of sample is negative — signal may be decaying or spurious. Not deployed due to instability.
- Sessions: [2026-04-14 session 197]

## H-1031: Same-Weekday Momentum XS
- Status: BORDERLINE
- Idea: Average return on same weekday over past 8 weeks.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.229, WF 2/4, SH p=0.096, H-012 corr **0.507** (too correlated).
- Notes: Passes SH but WF borderline and high momentum correlation. Weekday patterns captured by momentum.
- Sessions: [2026-04-14 session 197]

## H-1032: Intramonth Position XS
- Status: REJECTED
- Idea: First vs second half of month relative performance per asset.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.864, WF 1/4. WF fails.
- Notes: Intramonth seasonality has no stable XS edge.
- Sessions: [2026-04-14 session 197]

## H-1033: Lagged Week Return XS
- Status: CONFIRMED (deployed session 197)
- Idea: Prior week's XS return as signal for current week. Weekly momentum carry-over.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d)
- Result: IS Sharpe **1.400**, WF **4/5**, SH p=**0.050**, H-012 corr **-0.023**. Split-half: 1.342/1.550 (very stable).
- Notes: Weekly momentum persists. Clean signal with near-zero momentum correlation. Extremely stable split-half.
- Sessions: [2026-04-14 session 197]

## H-1034: Monthly Reversal XS
- Status: REJECTED
- Idea: Short recent monthly winners, long monthly losers. Monthly-horizon mean reversion.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe -0.299. 0% positive.
- Notes: Monthly reversal is anti-signal in crypto — consistent with strong momentum finding.
- Sessions: [2026-04-14 session 197]

## H-1035: Day-of-Month Seasonality XS
- Status: REJECTED
- Idea: Rolling average return by day-of-month phase (early/mid/late).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.629. Below 0.8 threshold.
- Notes: Day-of-month seasonality too noisy for XS ranking.
- Sessions: [2026-04-14 session 197]

## H-1036: Consecutive Return Direction XS
- Status: CONFIRMED (deployed session 197)
- Idea: Length of current win/loss streak. Short assets on long winning streaks, long those ending losing streaks (contrarian).
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d, N=5, low_long)
- Result: IS Sharpe **1.808**, WF **4/5**, SH p=**0.012**, H-012 corr **-0.036**. Split-half: 0.753/3.024 (improving over time).
- Notes: Contrarian streak signal — short extended winners, long extended losers. Works because of XS mean reversion at very short horizons. Negative corr with momentum = excellent diversifier.
- Sessions: [2026-04-14 session 197]

## H-1037: Return Regime Duration XS
- Status: CONFIRMED (not deployed — unstable split-half)
- Idea: Days since return regime changed (sign of rolling 10d return). Long established uptrends.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe **1.654**, WF 3/5, SH p=**0.021**, H-012 corr 0.009. Split-half: 2.909/**0.165** (2nd half barely positive).
- Notes: Regime duration signal strong IS but collapses in recent data. Not deployed.
- Sessions: [2026-04-14 session 197]

## H-1038: Mean Reversion Timer XS
- Status: BORDERLINE
- Idea: Days since price was at rolling max vs min.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.811, WF 3/4, SH p=0.263. SH fails.
- Notes: Concept is sound but signal too noisy. Split-half not significant.
- Sessions: [2026-04-14 session 197]

## H-1039: Return Acceleration XS
- Status: REJECTED
- Idea: Second derivative of price — change in momentum.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe -0.451. 0% positive.
- Notes: Momentum acceleration/deceleration has no XS predictive power.
- Sessions: [2026-04-14 session 197]

## H-1040: Momentum Freshness (EW) XS
- Status: BORDERLINE
- Idea: Exponentially-weighted momentum (halflife 10d, 60d window). Recent returns weighted more.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.848, WF 3/4, SH p=0.252. SH fails.
- Notes: EW momentum doesn't significantly improve over uniform momentum. Split-half not significant.
- Sessions: [2026-04-14 session 197]

## H-1041: Trend Persistence Ratio XS
- Status: CONFIRMED (deployed session 197)
- Idea: Fraction of days with same-sign return as overall 30d trend. Long persistent trends, short erratic.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d)
- Result: IS Sharpe **1.304**, WF **3/4**, SH p=**0.072**, H-012 corr **0.006**. Split-half: 1.151/1.532 (very stable).
- Notes: Measures quality of trend — consistent direction day-to-day. Near-zero corr with momentum means it captures trend quality, not trend magnitude.
- Sessions: [2026-04-14 session 197]

## H-1042: Recovery Rate XS
- Status: BORDERLINE
- Idea: Speed of recovery from recent drawdown.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.836 (low_long), WF 2/4, SH p=0.251. WF borderline, SH fails.
- Notes: Recovery rate concept doesn't work as XS signal — too noisy.
- Sessions: [2026-04-14 session 197]

## H-1043: Return Predictability (R-squared) XS
- Status: CONFIRMED (deployed session 197)
- Idea: R-squared of linear fit to log prices over 20 days. High R2 = smooth, predictable trend.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d)
- Result: IS Sharpe **1.313**, WF **5/5 PERFECT**, SH p=**0.068**, H-012 corr **0.008**. Split-half: 1.339/1.318 (near-identical!).
- Notes: **STAR signal** — perfect WF and remarkably stable split-half. Measures trend smoothness/predictability. Near-zero momentum corr = independent signal. Signed R2 captures both direction and quality.
- Sessions: [2026-04-14 session 197]

## H-1044: Volume Skewness XS
- Status: REJECTED
- Idea: Skewness of daily volume distribution.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.273. 25% positive. No signal.
- Notes: Volume skewness has no XS predictive power.
- Sessions: [2026-04-14 session 197]

## H-1045: Volume Concentration XS
- Status: REJECTED
- Idea: Max daily volume / mean volume. Concentrated institutional activity.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.852, WF 0/4. Complete WF failure.
- Notes: Volume concentration passes IS but zero OOS folds — classic overfit.
- Sessions: [2026-04-14 session 197]

## H-1046: Relative Volume Duration XS
- Status: CONFIRMED (deployed session 197)
- Idea: Consecutive days with short-term avg volume > long-term. Sustained high RVOL = institutional interest.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d)
- Result: IS Sharpe **2.000**, WF **5/5 PERFECT**, SH p=**0.006**, H-012 corr **0.015**. Split-half: 2.867/0.952 (both positive).
- Notes: **SESSION BEST** — sustained relative volume captures institutional accumulation. Perfect WF, highly significant. Near-zero momentum corr. Duration > level (RVOL level alone fails as per H-893).
- Sessions: [2026-04-14 session 197]

## H-1047: Volume-Price Agreement XS
- Status: CONFIRMED (deployed session 197)
- Idea: Correlation between volume and |returns|. High agreement = efficient pricing, information-rich trading.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 3d)
- Result: IS Sharpe **1.914**, WF **3/5**, SH p=**0.008**, H-012 corr **-0.018**. Split-half: 2.643/0.945 (both positive).
- Notes: Efficient market microstructure signal — when volume validates price moves. Near-zero momentum corr. Strong IS and significant.
- Sessions: [2026-04-14 session 197]

## H-1048: Volume Decay Rate XS
- Status: REJECTED
- Idea: Autocorrelation of volume — how fast volume spikes decay.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.844, WF 2/5. WF fails.
- Notes: Volume persistence as autocorrelation doesn't create stable XS spread.
- Sessions: [2026-04-14 session 197]

## H-1049: Volume Gini XS
- Status: REJECTED
- Idea: Gini coefficient of daily volumes. Concentrated vs distributed activity.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.336, WF 1/4. WF fails.
- Notes: Volume inequality passes IS but collapses OOS — classic overfit.
- Sessions: [2026-04-14 session 197]

## H-1050: Buy Volume Ratio Trend XS
- Status: REJECTED
- Idea: Trend in buy-volume ratio (close > open = buy bar).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe -0.131. 0% positive.
- Notes: Accumulation/distribution via open/close has no XS signal in crypto daily bars.
- Sessions: [2026-04-14 session 197]

## H-1051: Volume Momentum Spread XS
- Status: CONFIRMED (deployed session 197)
- Idea: Difference between short-term and mid-term volume ratios vs long-term. Accelerating volume interest.
- Instrument: futures (14 perps)
- Timeframe: 1D (rebal 5d)
...
## H-1172: Buy Pressure Index XS
- Status: REJECTED
- Idea: (close - low) / (high - low) averaged over 5d as order flow proxy.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.373, IS 25%, WF 2/4, SH 0.24/0.59 p=0.605, H-012 corr 0.037.
- Notes: Too weak. Buy pressure doesn't differentiate assets meaningfully.
- Sessions: [2026-04-15 session 203]

## H-1173: Volume Imbalance XS
- Status: CONFIRMED (not deployed)
- Idea: Up-day volume / down-day volume ratio over 10d.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.166, IS 41%, WF 2/4 [1.55, 1.19, -1.09, -1.23], SH 0.74/1.84 p=0.107, H-012 corr -0.010.
- Notes: Recent WF folds negative — signal may be decaying. Not deployed.
- Sessions: [2026-04-15 session 203]

## H-1174: Price Impact Ratio XS
- Status: REJECTED
- Idea: |return| / log(volume) avg 10d. Low impact = liquid.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.649, IS 50%, WF 4/4, SH -0.03/1.45 p=0.369, H-012 corr -0.036.
- Notes: WF perfect but IS too low and SH first half negative. Not reliable.
- Sessions: [2026-04-15 session 203]

## H-1175: Accumulation/Distribution Change XS
- Status: REJECTED
- Idea: 20d change in A/D line (CLV × volume).
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.885, IS 50%, WF 4/4, SH 0.62/1.26 p=0.221, H-012 corr -0.014.
- Notes: WF perfect but p too high. Borderline — could revisit with tighter params.
- Sessions: [2026-04-15 session 203]

## H-1176: Money Flow Index XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: RSI applied to typical_price × volume, 14d period. Long high MFI.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.762, IS 41%, WF 4/4 PERFECT [1.40, 3.69, 1.59, 2.16], SH 1.79/1.75 p=0.015, H-012 corr 0.085.
- Notes: Strong order flow signal. Very stable split-half. WF all positive. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1177: Force Index XS
- Status: REJECTED
- Idea: (close diff) × volume, 13d EMA, normalized.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.321, IS 33%, WF 3/4, SH 0.37/0.26 p=0.656, H-012 corr 0.044.
- Notes: Too weak. Force index doesn't capture XS dynamics.
- Sessions: [2026-04-15 session 203]

## H-1178: Ease of Movement XS
- Status: REJECTED
- Idea: Mid-price diff / (volume / range), 14d avg.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.824, IS 50%, WF 4/4, SH 0.26/1.52 p=0.254, H-012 corr 0.035.
- Notes: WF perfect but low IS, SH first half nearly zero. Not robust.
- Sessions: [2026-04-15 session 203]

## H-1179: Chaikin Oscillator XS
- Status: REJECTED
- Idea: EMA(3) - EMA(10) of A/D line, normalized.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.280, IS 25%, WF 3/4, SH -0.69/1.52 p=0.698, H-012 corr 0.008.
- Notes: Very weak IS. SH first half negative. Not viable.
- Sessions: [2026-04-15 session 203]

## H-1180: Recent vs Distal Momentum XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: 5d return now minus 5d return from 55d ago. Contrarian: long momentum decelerators.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 2.047, IS 50%, WF 3/4 [-1.37, 2.19, 1.43, 2.34], SH 1.97/2.25 p=0.005, H-012 corr 0.034.
- Notes: STAR signal. Very low p-value, perfectly stable SH. Direction=low_long (contrarian). One WF fold negative but 3/4 strong. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1181: Momentum Gap XS
- Status: REJECTED
- Idea: 60d return minus 120d return. Long-horizon acceleration.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.538, IS 41%, WF 2/4, SH 0.76/0.24 p=0.457, H-012 corr -0.050.
- Notes: Too weak. Long horizon acceleration doesn't persist.
- Sessions: [2026-04-15 session 203]

## H-1182: Path-Dependent Momentum XS
- Status: REJECTED
- Idea: Streak-weighted cumulative 30d returns. Consecutive same-sign moves weighted more.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.521, IS 41%, WF 2/4, SH 1.24/-0.49 p=0.470, H-012 corr 0.002.
- Notes: SH collapse in second half. Path dependency doesn't help XS.
- Sessions: [2026-04-15 session 203]

## H-1183: Smoothness-Adjusted Momentum XS
- Status: REJECTED
- Idea: 20d return / (1 + 20d vol). Return per unit risk.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.013, IS 50%, WF 2/4, SH 0.94/1.15 p=0.161, H-012 corr 0.033.
- Notes: IS decent but WF unstable (recent folds negative). Vol adjustment doesn't add alpha.
- Sessions: [2026-04-15 session 203]

## H-1184: Recency-Weighted Return XS
- Status: REJECTED
- Idea: EWM return with half-life 10d. Recent days count more.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.694, IS 33%, WF 2/4, SH 1.49/-0.32 p=0.337, H-012 corr 0.024.
- Notes: SH collapse in second half. Momentum reweighting doesn't add value.
- Sessions: [2026-04-15 session 203]

## H-1185: Momentum Consistency XS
- Status: CONFIRMED (not deployed)
- Idea: % of positive 5d sub-period returns over 30d.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.500, IS 75%, WF 2/4 [0.19, -0.66, -0.44, 0.45], SH 1.01/2.18 p=0.038, H-012 corr -0.005.
- Notes: Strong p-value and IS% (75%) but WF 3 of 4 folds near zero/negative. Not deployed.
- Sessions: [2026-04-15 session 203]

## H-1186: Up-Capture minus Down-Capture XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: Asymmetric market participation. Long high up-capture / low down-capture ratio.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.240, IS 50%, WF 4/4 PERFECT [1.36, 1.46, 1.26, 1.26], SH 1.23/1.28 p=0.086, H-012 corr 0.024.
- Notes: Extremely stable — all 4 WF folds within 1.26-1.46. SH nearly identical (1.23/1.28). Very independent signal. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1187: Idiosyncratic Momentum XS
- Status: REJECTED
- Idea: Cumulative residual return (return - beta × market), 30d.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.819, IS 50%, WF 2/4, SH 1.42/-0.03 p=0.257, H-012 corr -0.008.
- Notes: SH collapse. Idiosyncratic momentum doesn't hold in crypto.
- Sessions: [2026-04-15 session 203]

## H-1188: Breakout Distance XS
- Status: REJECTED
- Idea: (close - 40d high) / 40d range. Proximity to breakout.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.599, IS 50%, WF 1/4, SH 0.73/0.45 p=0.406, H-012 corr 0.025.
- Notes: WF 1/4 — fails badly OOS. Breakout proximity is not a viable XS signal.
- Sessions: [2026-04-15 session 203]

## H-1189: Support Strength XS
- Status: REJECTED
- Idea: Number of bounces near 20d low over 20d. Anti-fragility.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.911, IS 75%, WF 3/4, SH 0.79/1.09 p=0.207, H-012 corr -0.006.
- Notes: Interesting concept (low_long — fewer bounces = outperform) but p too high.
- Sessions: [2026-04-15 session 203]

## H-1190: Hurst Exponent XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: R/S Hurst exponent over 40d. Long trending (H>0.5), short mean-reverting.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.725, IS 50%, WF 3/4 [0.38, -1.93, 1.35, 1.85], SH 1.89/1.67 p=0.017, H-012 corr -0.075.
- Notes: Genuine new factor — anti-correlated with momentum (-0.075). Trending assets outperform. Very stable SH. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1191: Return Autocorrelation XS
- Status: REJECTED
- Idea: Autocorrelation of 5d returns over 60d window. Regime persistence.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.031, IS 50%, WF 2/4, SH 1.35/0.58 p=0.154, H-012 corr -0.053.
- Notes: Borderline — decent IS and anti-momentum, but WF too unstable.
- Sessions: [2026-04-15 session 203]

## H-1192: Volatility of Volatility XS
- Status: REJECTED
- Idea: Std of 5d rolling vol over 20d window.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 0.634, IS 50%, WF 4/4, SH -0.04/1.50 p=0.380, H-012 corr 0.001.
- Notes: WF perfect but IS too low and SH first half flat. Very independent (corr 0.001).
- Sessions: [2026-04-15 session 203]

## H-1193: Gap Fill Ratio XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: % of overnight gaps filled same day over 20d. Market microstructure quality.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.905, IS 100%, WF 4/4 PERFECT [0.90, 1.36, 1.43, 2.42], SH 2.65/1.11 p=0.008, H-012 corr -0.016. SESSION BEST.
- Notes: Exceptional signal — 100% IS positive, perfect WF, very low p-value. Assets that fill gaps more often outperform. Independent of momentum. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1194: Trend Linearity XS
- Status: LIVE (paper trade since 2026-04-15)
- Idea: Signed R² of linear regression on log-closes over 20d. Clean trends outperform.
- Instrument: futures (14 perps)
- Timeframe: 1D
- Result: IS Sharpe 1.316, IS 50%, WF 3/4, SH 1.28/1.40 p=0.069, H-012 corr -0.036.
- Notes: Very stable SH (1.28/1.40). Anti-momentum. Clean trending assets outperform noisy ones. Deployed.
- Sessions: [2026-04-15 session 203]

## H-1195: Mean Reversion Speed XS
- Status: REJECTED
- Idea: OU process half-life estimated from 40d window.
- Instrument: futures (14 perps)
- Timeframe: 1D
