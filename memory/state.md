...
## Portfolio Summary (live mark-to-market 2026-03-31 session 119, 17:07 UTC)
- **Bybit Demo**: ~$98,020 (-1.98%) — 13 perp positions. BTC ~$67,805.
- **Total internal MTM (19 strats, BTC ~$67,805)**: ~$191,542 (+0.81%). BTC $67,805 (+1.7% from session 118).
- **Positive (13/18 old + 1 new)**: H-031 (+5.34%), H-039 (+4.35%), H-012 (+2.74%), H-019 (+2.26%), H-062 (+1.72%), H-053 (+1.32%), H-063 (+1.10%), H-052 (+0.54%), H-049 (+0.50%), H-046 (+0.48%), H-076 (+0.41%), H-085 (+0.08%), H-059 (+0.07%)
- **Negative (5)**: H-032 (-0.06%), H-009 (-0.42%), H-044 (-0.67%), H-011 (-1.34%), H-021 (-2.43%)
- **H-009**: $9,958 (-0.42%, SHORT) | **H-011**: $9,866 (-1.34%, IN) | **H-012**: $10,274 (+2.74%) | **H-019**: $10,226 (+2.26%) | **H-021**: $9,757 (-2.43%)
- **H-024**: KILLED session 114. H-019 won: +7.44% vs -0.20% (7.64% gap over 13 days).
- **H-031**: $10,534 (+5.34%) | **H-032**: $9,994 (-0.06%) | **H-039 (DOW)**: $10,435 (+4.35%, FLAT)
- **H-044 (OI)**: $9,933 (-0.67%) | **H-046 (Accel)**: $10,048 (+0.48%) | **H-049 (LSR)**: $10,050 (+0.50%)
- **H-052 (Premium)**: $10,054 (+0.54%) | **H-053 (Funding XS)**: $10,132 (+1.32%)
- **H-059 (Vol Term)**: $10,007 (+0.07%) | **H-062 (DD Mom)**: $10,172 (+1.72%)
- **H-063 (Vol Sell)**: **$10,110 (+1.10% MTM)** — flipped positive! BTC rally + theta decay. PUT ITM by ~$1,195. $1,110 buffer to stop. 2.6d to expiry.
- **H-076 (Efficiency)**: $10,041 (+0.41%) | **H-085 (Turnover)**: $10,008 (+0.08%)
- **H-160 (Trend Quality)**: $9,976 (-0.24%, NEW) — deployed this session. LONG ETH/DOGE/SOL, SHORT BTC/OP/ATOM.
- **Paper trade age**: H-009/H-011/H-012: 15 days. H-019/H-021: 14 days. H-031/H-032/H-039: 12 days. H-044/H-046/H-049/H-052/H-053: 11 days. H-059/H-062: 9 days. H-063: 6 days. H-076/H-085: 6 days. H-160: 0 days.
- **H-063 status**: BTC ~$67,805, put strike $69,000 — PUT ITM by ~$1,195. Equity $10,110 (+1.10%). Stop at $9,000 (**$1,110 buffer**). 2.6 days to expiry (Apr 3 08:00). Theta decay + BTC rally driving towards profit.
- **H-011 status**: IN, capital $9,866 (-1.34%). Net funding vs fees still negative.
- **Demo**: ~$98,020 (-1.98%). SOL long still dragging. Need to monitor on next bar.
- **Rebal status**: Mar 31 bar (00:30 UTC Apr 1): H-012/H-046/H-062 rebal. Apr 1: H-085. Apr 2: H-039 LONG + H-160. Apr 3: H-063 expiry + H-031 rebal. Apr 4: H-021/H-049/H-052/H-076.
- **Research**: 163 hypotheses total. H-161 REJECTED (variance ratio, 52.8% IS). H-162 REJECTED (MAX effect, 66.7% best). H-163 REJECTED (momentum concentration, 79.2% close but fails). **H-160 deployed** as paper trade #19.
