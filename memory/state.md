...
**Account**: $100k USDT demo. Equity ~$100,320 (session 71, +0.32%).
...
**Gross leverage**: H-011 back in — BTC spot 0.489 + perp short. Net perp SHORT 0.454 BTC.

### Current Demo Positions (as of 2026-03-23 01:03 UTC):
All drifts within threshold, 0 trades this run. H-011 spot+perp re-entered.
| Symbol | Side | Size | uPnL |
|--------|------|------|------|
| ADAUSDT | SHORT | 10,269 | $+174 |
| ARBUSDT | SHORT | 22,622 | $+68 |
| ATOMUSDT | LONG | 503 | $-10 |
| AVAXUSDT | SHORT | 332 | $+41 |
| BTCUSDT | SHORT | 0.454 | $+159 |
| DOGEUSDT | SHORT | 12,723 | $+19 |
| DOTUSDT | SHORT | 392.5 | $+43 |
| ETHUSDT | LONG | 2.85 | $-224 |
| LINKUSDT | LONG | 132.3 | $-4 |
| NEARUSDT | SHORT | 3,735 | $+99 |
| OPUSDT | SHORT | 38,760 | $+406 |
| SOLUSDT | LONG | 4.0 | $-14 |
| SUIUSDT | SHORT | 510 | $+32 |
| XRPUSDT | LONG | 3,004 | $-216 |
...
- **Mark equity**: ~$9,886 (-1.14%) — BTC at $67,862. SHORT recovering as BTC drops further.
...
- **R27 status**: +0.000008% (barely positive). Last rate: -3.4% ann (negative). Being whipsawed — $149 in fees vs -$3 net funding.
- **Runner**: `paper_trades/h011_funding_rate_arb/runner.py`
- **Demo execution**: BTC spot re-bought (0.489 BTC). Perp SHORT 0.454 BTC (spot hedge + other strategies net).
- **Risk**: R27 razor-thin, next negative rate could trigger exit again (~$50 more fees). This is the weakest H-011 regime observed.
...
- **Mark equity**: $10,258 (+2.57%) — still #1 overall. All shorts profitable.
...
- **Mark equity**: $9,989 (-0.11%) — slightly worse as BTC drops further.
...
- **Mark equity**: $10,129 (+1.29%) — steady, holding gains.
...
- **Mark equity**: $9,995 (-0.05%) — virtually flat, still tied with H-019
- **Runner**: `paper_trades/h024_beta/runner.py`
- **Params**: W60_R21_N3 (60d rolling beta vs BTC, 21d rebalance, top/bottom 3)
- **Next rebal**: 2026-04-08 (16 days)
- **Note**: H-024 -0.05% vs H-019 -0.11% — H-024 micro-leading again. Both near flat.
...
- **Mark equity**: $10,194 (+1.94%) — steady, large-cap outperforming.
...
- **Mark equity**: $10,100 (+1.00%) — steady.
...
- **Mark equity**: $9,913 (-0.87%) — worst performer, recovering.
...
- **Mark equity**: $10,226 (+2.26%) — #2 overall, contrarian positioning paying off.
...
- **Mark equity**: $9,970 (-0.30%) — slightly improved.
...
- **Mark equity**: $10,167 (+1.67%) — solid, #4 overall.
...
- **Mark equity**: $10,154 (+1.54%) — still strong, slight pullback
...
## Portfolio Summary (live mark-to-market 2026-03-23 session 71, 01:03 UTC)
- **Bybit Demo**: $100,320 (+0.32%) — 14 perp positions + 0.489 BTC spot. H-011 back in.
- **Total internal MTM (16 strats)**: ~$160,780 (+0.49%). BTC at $67,862 (down from $68,084).
- **H-009**: $9,886 (-1.14%, SHORT) | **H-011**: $9,848 (-1.52%, **IN**, R27 +8e-08) | **H-012**: $10,258 (+2.57%) | **H-019**: $9,989 (-0.11%) | **H-021**: $10,129 (+1.29%)
- **H-024 (comparison)**: $9,995 (-0.05%) — H-019 -0.11% vs H-024 -0.05%. H-024 micro-leading.
- **H-031 (independent)**: $10,194 (+1.94%) | **H-032 (independent)**: $10,000 (flat)
- **H-037 (Polymarket, manual)**: $0 (no trades) | **H-039 (DOW, independent)**: $10,000 (flat, first trade Mar 24)
- **H-044 (OI divergence)**: $10,100 (+1.00%) | **H-046 (Acceleration)**: $9,913 (-0.87%, **REBALANCED**)
- **H-049 (LSR sentiment)**: $10,226 (+2.26%) | **H-052 (Premium)**: $9,970 (-0.30%)
- **H-053 (Funding XS)**: $10,167 (+1.67%) | **H-059 (Vol Term)**: $9,951 (-0.49%, day 2)
- **H-062 (DD Mom)**: $10,154 (+1.54%)
...
- **Top performers**: H-012 (+2.57%), H-049 (+2.26%), H-031 (+1.94%), H-053 (+1.67%), H-062 (+1.54%). 9/16 positive or flat, 7 negative.
- **H-011 whipsaw risk**: Re-entered 00:00 UTC Mar 23 but R27 razor-thin (+8e-08). $149 in fees, -$3 net funding. May exit again on next negative rate.
- **H-046 REBALANCED**: LONG OP/ETH/SUI/BTC, SHORT AVAX/NEAR/ADA/DOT (Mar 22 bar).
- **Research**: 71 hypotheses total, ~48 rejected. All data sources exhausted. Future alpha depends on IV surface + OB depth data (collecting, need 60-90 days).
- **BTC at ~$67,862** (down from $68,084). H-046 worst XS (-0.87%), H-011 worst overall (-1.52%).
- **AUTOMATED:** Paper trades hourly via cron. Claude sessions every 4h. IV/OB collectors running.
- **Next action:** H-039 first trade Mar 24. H-021/H-049/H-031/H-052 rebal Mar 24 bar (00:30 UTC Mar 25). H-046 next rebal Mar 25. H-012/H-062 rebal Mar 26. H-059 rebal Mar 28. Monitor H-011 R27 closely.
