...
### Current Demo Positions (as of 2026-03-24 17:07 UTC):
All drifts within threshold, 0 trades this run. No spot BTC. BTC -2.3% selloff.
| Symbol | Side | Size | Notional | uPnL |
|--------|------|------|----------|------|
| ADAUSDT | SHORT | 63,291 | $16,500 | $+63 |
| ARBUSDT | SHORT | 134,821 | $12,750 | $-156 |
| ATOMUSDT | LONG | 6,388 | $11,250 | $+53 |
| AVAXUSDT | SHORT | 1,669 | $15,750 | $+93 |
| BTCUSDT | LONG | 0.645 | $45,746 | $-1,102 |
| DOGEUSDT | SHORT | 110,701 | $10,500 | $+177 |
| DOTUSDT | LONG | 525 | $750 | $-30 |
| ETHUSDT | LONG | 18.51 | $39,743 | $-558 |
| LINKUSDT | LONG | 1,155 | $10,499 | $-27 |
| NEARUSDT | SHORT | 25,952 | $33,745 | $+324 |
| OPUSDT | SHORT | 374,671 | $42,750 | $+1,450 |
| SOLUSDT | LONG | 16.5 | $1,502 | $-32 |
| SUIUSDT | SHORT | 7,050 | $6,743 | $+155 |
| XRPUSDT | LONG | 20,358 | $29,244 | $-926 |
...
- **Mark equity**: ~$9,790 (-2.10%) — BTC at $69,231, SHORT gaining as BTC drops.
...
- **R7 status**: **+0.76% ann (improving)**. R27: +1.25% ann. Latest rate +5.70% ann. 5/6 recent settlements positive.
...
- **Risk**: R27 positive (no exit risk). **R7 positive** — 5 of last 6 settlements positive (up to +5.7% ann). Whipsaw risk minimal.
...
- **Mark equity**: $10,293 (+2.93%) — recovering well.
...
- **Mark equity**: $10,056 (+0.56%) — **H-019 leads H-024 by 2.50%**.
...
- **Mark equity**: $9,895 (-1.05%) — roughly stable.
...
- **Mark equity**: $9,806 (-1.94%) — BTC drop hurting long side.
- **Runner**: `paper_trades/h024_beta/runner.py`
- **Params**: W60_R21_N3 (60d rolling beta vs BTC, 21d rebalance, top/bottom 3)
- **Next rebal**: 2026-04-08 (15 days)
- **Note**: H-019 +0.56% vs H-024 -1.94% — **H-019 leads by 2.50%**. Gap widened from 1.90%.
...
- **Mark equity**: $10,401 (+4.01%) — steady, near top.
...
- **Mark equity**: $10,074 (+0.74%) — pulled back.
...
- **Mark equity**: $9,882 (-1.18%) — dipped on BTC selloff.
...
- **Mark equity**: $10,433 (+4.33%) — **#1 overall**, contrarian positioning strengthening.
...
- **Mark equity**: $10,128 (+1.28%) — improving steadily.
...
- **Mark equity**: $10,138 (+1.38%) — steady.
...
- **Mark equity**: $9,884 (-1.16%) — recovering, day 3.
...
- **Mark equity**: $10,292 (+2.92%) — gaining strength.
...
## Portfolio Summary (live mark-to-market 2026-03-24 session 81, 17:07 UTC)
- **Bybit Demo**: $99,821 (-0.18%) — 14 perp positions, no spot BTC. H-056 positions aligned. Leverage 2.79x. Improved from -0.28% despite BTC -2.3%.
- **Total internal MTM (16 strats)**: ~$160,928 (+0.58%). BTC at $69,231 (down $1,638 from session 80). Portfolio flat despite sharp BTC drop — market neutrality working.
- **H-009**: $9,790 (-2.10%, SHORT) | **H-011**: $9,856 (-1.44%, **IN**, R7 +0.76%) | **H-012**: $10,293 (+2.93%) | **H-019**: $10,056 (+0.56%) | **H-021**: $9,895 (-1.05%)
- **H-024 (comparison)**: $9,806 (-1.94%) — H-019 +0.56% vs H-024 -1.94%. **H-019 leads by 2.50%** (widened from 1.90%).
- **H-031 (independent)**: $10,401 (+4.01%) | **H-032 (independent)**: $10,000 (flat)
- **H-037 (Polymarket, manual)**: $0 (no trades) | **H-039 (DOW, independent)**: $10,000 (flat, first trade tonight)
- **H-044 (OI divergence)**: $10,074 (+0.74%) | **H-046 (Acceleration)**: $9,882 (-1.18%)
- **H-049 (LSR sentiment)**: $10,433 (+4.33%) | **H-052 (Premium)**: $10,128 (+1.28%)
- **H-053 (Funding XS)**: $10,138 (+1.38%) | **H-059 (Vol Term)**: $9,884 (-1.16%, day 3)
- **H-062 (DD Mom)**: $10,292 (+2.92%)
...
- **Top performers**: H-049 (+4.33%), H-031 (+4.01%), H-012 (+2.93%), H-062 (+2.92%), H-053 (+1.38%). 8/16 positive, 6 negative, 2 flat.
- **H-011 R7**: +0.76% ann (improved from +0.28%). R27: +1.25% ann. Latest rate +5.70% ann. 5/6 recent settlements positive.
...
- **Next action:** Tonight (00:30 UTC Mar 25): H-021/H-031/H-049/H-052 rebal + H-039 first trade. H-046 rebal Mar 25. H-012/H-062 rebal Mar 26. H-059 rebal Mar 28.
