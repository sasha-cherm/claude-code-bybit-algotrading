...
RUNNERS = [
    ...
    ("H-1007", ROOT / "paper_trades" / "h1007_intraweek_recovery" / "runner.py"),
    ("H-1009", ROOT / "paper_trades" / "h1009_consecutive_up" / "runner.py"),
    ("H-1010", ROOT / "paper_trades" / "h1010_weekly_vol_profile" / "runner.py"),
    ("H-1013", ROOT / "paper_trades" / "h1013_dd_recovery" / "runner.py"),
    ("H-1016", ROOT / "paper_trades" / "h1016_vol_rank_persist" / "runner.py"),
    ("H-1018", ROOT / "paper_trades" / "h1018_price_compression" / "runner.py"),
    ("H-1023", ROOT / "paper_trades" / "h1023_return_stability" / "runner.py"),
    ("H-1028", ROOT / "paper_trades" / "h1028_tom_effect" / "runner.py"),
    ("H-1033", ROOT / "paper_trades" / "h1033_lagged_week" / "runner.py"),
    ("H-1036", ROOT / "paper_trades" / "h1036_consec_return_dir" / "runner.py"),
    ("H-1041", ROOT / "paper_trades" / "h1041_trend_persistence" / "runner.py"),
    ("H-1043", ROOT / "paper_trades" / "h1043_return_predictability" / "runner.py"),
    ("H-1046", ROOT / "paper_trades" / "h1046_rel_vol_duration" / "runner.py"),
    ("H-1047", ROOT / "paper_trades" / "h1047_vol_price_agreement" / "runner.py"),
    ("H-1051", ROOT / "paper_trades" / "h1051_vol_mom_spread" / "runner.py"),
    ("H-1065", ROOT / "paper_trades" / "h1065_oi_rank_stability" / "runner.py"),
    ("H-1068", ROOT / "paper_trades" / "h1068_intraday_vol_ratio" / "runner.py"),
    ("H-1071", ROOT / "paper_trades" / "h1071_range_expansion" / "runner.py"),
    ("H-1077", ROOT / "paper_trades" / "h1077_rank_change_mom" / "runner.py"),
    ("H-1078", ROOT / "paper_trades" / "h1078_outperf_consistency" / "runner.py"),
    ("H-1081", ROOT / "paper_trades" / "h1081_rel_vol_surprise" / "runner.py"),
    ("H-1087", ROOT / "paper_trades" / "h1087_return_kurtosis" / "runner.py"),
    ("H-1090", ROOT / "paper_trades" / "h1090_consec_extreme" / "runner.py"),
    ("H-1091", ROOT / "paper_trades" / "h1091_overnight_share" / "runner.py"),
    ...
    ("H-1154", ROOT / "paper_trades" / "h1154_price_channel" / "runner.py"),
    ("H-1155", ROOT / "paper_trades" / "h1155_roc_divergence" / "runner.py"),
    ("H-1156", ROOT / "paper_trades" / "h1156_ma_convergence" / "runner.py"),
    ("H-1161", ROOT / "paper_trades" / "h1161_vpt_change" / "runner.py"),
    ("H-1162", ROOT / "paper_trades" / "h1162_acceleration" / "runner.py"),
    ("H-1163", ROOT / "paper_trades" / "h1163_on_intra_ratio" / "runner.py"),
    ("H-1176", ROOT / "paper_trades" / "h1176_mfi" / "runner.py"),
    ("H-1180", ROOT / "paper_trades" / "h1180_recent_distal_mom" / "runner.py"),
    ("H-1186", ROOT / "paper_trades" / "h1186_up_down_capture" / "runner.py"),
    ...
    ("H-1221", ROOT / "paper_trades" / "h1221_approx_entropy" / "runner.py"),
    ("H-1223", ROOT / "paper_trades" / "h1223_lz_complexity" / "runner.py"),
    ("H-1233", ROOT / "paper_trades" / "h1233_dd_frequency" / "runner.py"),
    ("H-1234", ROOT / "paper_trades" / "h1234_mean_recovery_time" / "runner.py"),
    ("H-1237", ROOT / "paper_trades" / "h1237_ud_vol_asym" / "runner.py"),
    ("H-1238", ROOT / "paper_trades" / "h1238_post_drop_recovery" / "runner.py"),
    ("H-1243", ROOT / "paper_trades" / "h1243_tail_asym_ratio" / "runner.py"),
    ("H-1247", ROOT / "paper_trades" / "h1247_info_discrete" / "runner.py"),
    ("H-1251", ROOT / "paper_trades" / "h1251_crash_freq" / "runner.py"),
    ("H-1252", ROOT / "paper_trades" / "h1252_rel_intraday_range" / "runner.py"),
    ("H-1253", ROOT / "paper_trades" / "h1253_close_position" / "runner.py"),
    ("H-1256", ROOT / "paper_trades" / "h1256_gap_freq" / "runner.py"),
    ("H-1257", ROOT / "paper_trades" / "h1257_tr_trend" / "runner.py"),
    ("H-1258", ROOT / "paper_trades" / "h1258_candle_direction" / "runner.py"),
    ("H-1259", ROOT / "paper_trades" / "h1259_hl_asymmetry" / "runner.py"),
    ("H-1263", ROOT / "paper_trades" / "h1263_rr_trend" / "runner.py"),
    ("H-1265", ROOT / "paper_trades" / "h1265_cvar" / "runner.py"),
    ("H-1266", ROOT / "paper_trades" / "h1266_max_consec_loss" / "runner.py"),
    ("H-1270", ROOT / "paper_trades" / "h1270_range_contraction" / "runner.py"),
    ("H-1271", ROOT / "paper_trades" / "h1271_oc_drift" / "runner.py"),
    ("H-1275", ROOT / "paper_trades" / "h1275_range_position" / "runner.py"),
    ("H-1276", ROOT / "paper_trades" / "h1276_variance_trend" / "runner.py"),
    ...
    ("H-1340", ROOT / "paper_trades" / "h1340_vol_weighted_ret" / "runner.py"),
    ("H-1349", ROOT / "paper_trades" / "h1349_left_tail_shrink" / "runner.py"),
    ("H-1350", ROOT / "paper_trades" / "h1350_right_tail_growth" / "runner.py"),
    ("H-1354", ROOT / "paper_trades" / "h1354_es_trend" / "runner.py"),
    ("H-1355", ROOT / "paper_trades" / "h1355_width_change" / "runner.py"),
    ("H-1356", ROOT / "paper_trades" / "h1356_sl_mom_gap" / "runner.py"),
    ("H-1367", ROOT / "paper_trades" / "h1367_right_cvar" / "runner.py"),
    ("H-1370", ROOT / "paper_trades" / "h1370_downside_std_change" / "runner.py"),
    ("H-1371", ROOT / "paper_trades" / "h1371_upside_std_change" / "runner.py"),
    ("H-1379", ROOT / "paper_trades" / "h1379_mom_lifecycle" / "runner.py"),
    ("H-1382", ROOT / "paper_trades" / "h1382_xs_rank_trend" / "runner.py"),
    ("H-1405", ROOT / "paper_trades" / "h1405_pos_day_share" / "runner.py"),
    ("H-1411", ROOT / "paper_trades" / "h1411_drift_diffusion" / "runner.py"),
]
